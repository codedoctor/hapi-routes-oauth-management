...
(function() {
  module.exports = {
    ...
    optionsRoutesAppsBaseNameRequired: "options parameter requires a routesAppsBaseName (oauth-apps)",
    optionsRoutesScopesBaseNameRequired: "options parameter requires a routesScopesBaseName (oauth-scopes)",
    optionsServerAdminScopeNameRequired: "options parameter requires a serverAdminScopeName (server-admin)",
    couldNotFindPlugin: "Could not find 'hapi-oauth-store-multi-tenant' plugin.",
