(function() {
  ...
  module.exports = {
    ...
    payloadOauthScopesPatch: Joi.object().keys().options({
      allowUnkown: true,
      stripUnknown: false
    }),
    payloadOauthScopesPost: Joi.object().keys().options({
      allowUnkown: true,
      stripUnknown: false
    }),
    ...
    payloadOauthAppsPatch: Joi.object().keys().options({
      allowUnkown: true,
      stripUnknown: false
    }),
    payloadOauthAppsPost: Joi.object().keys().options({
      allowUnkown: true,
      stripUnknown: false
    })
  };
